...
% %========================================================================================================
% % % run function R_MainFunPRank and study the impact of changing r_set on memory 
 ...
 R_MainFunPR_Mem(a, cin,cout, r_set, lambda, K, QC);       % Fixed QC studies the impact of different r_set on memory of three algorithms(PR_IT,PR_NI,PR_Our)
% % %============================================================================================================================== 


% %========================================================================================================
% % % run function Q_MainFunPR_Mem and study the effect of changing QC on memory
% fprintf('>>>>>>>\n    The name of Dataset:         %s\n',ds); 
% r_set = 100;   
% QC = [50 100 150 200 250];   
% Q_MainFunPR_Mem(a, cin,cout, r_set, QC, K, lambda);   % Fixed  r_set studies the effect of different QC on memory of various algorithms
